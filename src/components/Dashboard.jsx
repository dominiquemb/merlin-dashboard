                    ...
                    <div key={meeting.id} className="bg-[#fafafa] border border-gray-100 rounded-2xl p-6">
                      ...
                      <div className="grid grid-cols-3 gap-4 mb-4">
                        ...
                        <div className="flex items-start gap-1 text-sm text-gray-600">
                          <FiVideo className="w-4 h-4 mt-0.5 flex-shrink-0" />
                          <div className="flex-1">
                            {(() => {
                              const loc = meeting.location;
                              if (!loc) return <span>Meeting</span>;
                              if (typeof loc !== 'string') return <span>Meeting</span>;
                              const trimmed = loc.trim();
                              if (!trimmed || trimmed === 'No Location' || trimmed === 'No location') return <span>Meeting</span>;
                              
                              // Parse Zoom link, password, and email
                              // Format: "https://zoom.us/j/...?. pwd=... /email@domain.com"
                              // Or: "https://zoom.us/j/...?pwd=... /email@domain.com"
                              
                              // Check if it contains a Zoom URL
                              ...
                              if (zoomMatch) {
                                ...
                                // Extract password if present (pwd=... can be after URL or in the string)
                                ...
                                // Extract email if present (after / or space, typically at the end)
